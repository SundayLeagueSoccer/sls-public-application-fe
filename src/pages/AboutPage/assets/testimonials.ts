export const testimonials = [
  ...
  {
    playerName: "Mumin Alao",
    statement:
      "The league is very competitive I mean there’s enough competition for place in the team but we need to know beautiful football doesn’t need violence",
    postion: "AMF",
  },
  {
    playerName: "Damola OG",
    statement:
      "This league helps me ease my stress after a stressful work week in Lagos,  I think it’s been amazing so far hanging out and playing with them boys. I look forward to better development, growth of the league",
    postion: "DEF",
  },
  {
    playerName: "Ifeanyi Christian",
    statement:
      "Hi I'm Ifeanyi Christian, my Experience in SlS is so awesome, the guys in the field of play are so wonderful with alot of good Energies. In Summary I look forward to every weekends just to enjoy and have fun on Sundays in SLS.",
    postion: "DEF",
  },
];
